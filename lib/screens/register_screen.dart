...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  // ✅ الافتراضي null لإجبار المستخدم على الاختيار
  ...
  Future<void> _handleRegister() async {
    ...
    try {
      ...
      // بناء البريد الإلكتروني الذكي بناءً على رقم الهاتف
      String smartEmail = "${_phoneController.text.trim()}@aksabship.com";
      // كلمة مرور افتراضية ثابتة داخلياً بما أنه تم إلغاء حقل كلمة المرور للمستخدم
      String internalSecurePassword = "AksabSmartPassword123!";

      UserCredential userCredential = await FirebaseAuth.instance.createUserWithEmailAndPassword(
        email: smartEmail,
        password: internalSecurePassword,
      );
      ...
      if (_selectedRole == 'free_driver') {
        ...
        userData['insurance_points'] = 0.0; // دمج التسمية التقنية المعتمدة لإدارة العهدة
  ...
  // ✅ اللوجو نظيف وبدون أيقونة الموتوسيكل الخلفية
  ...
  // ✅ جعل القيمة الافتراضية فارغة وإضافة Validator لإجبار الاختيار
  Widget _buildVehiclePicker() {
    return Container(
      ...
      child: DropdownButtonFormField<String>(
        ...
        validator: (value) => value == null ? "يرجى اختيار نوع المركبة" : null,
      ),
    );
  }
