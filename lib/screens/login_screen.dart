                      ...
                      Positioned(
                        ...
                        child: Column(
                          children: [
                            _buildHeroLogo(),
                            SizedBox(height: 2.h),
                            Text("رابية أحلى - كابتن",
                                style: TextStyle(fontSize: 26.sp, fontWeight: FontWeight.bold, color: Colors.white, fontFamily: 'Cairo')),
  ...
  Widget _buildHeroLogo() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [BoxShadow(color: Colors.orange.withOpacity(0.4), blurRadius: 25, spreadRadius: 8)],
      ),
      ...
      child: Row(
        ...
        children: [
          ...
          Text("سياسة الخصوصية وشروط الاستخدام",
              style: TextStyle(color: Colors.grey[600], fontSize: 11.sp, fontFamily: 'Cairo', fontWeight: FontWeight.w600)),
        ],
      ),
    );
  }
